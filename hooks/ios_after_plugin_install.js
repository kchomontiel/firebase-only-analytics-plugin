...
module.exports = function (context) {
  ...
  const iosPlatformPath = path.join(
    context.opts.projectRoot,
    "platforms",
    "ios"
  );
  console.log(
    "Firebase Analytics Plugin: Checking iOS platform at:",
    iosPlatformPath
  );
  console.log(
    "Firebase Analytics Plugin: iOS platform exists:",
    fs.existsSync(iosPlatformPath)
  );

  if (!fs.existsSync(iosPlatformPath)) {
    console.log(
      "Firebase Analytics Plugin: iOS platform not found, skipping hook"
    );
    return;
  }

  console.log(
    "Firebase Analytics Plugin: iOS platform found, continuing with hook execution"
  );
